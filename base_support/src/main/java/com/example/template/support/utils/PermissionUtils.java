...
import com.example.template.support.constants.PermissionConstant;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(BaseApplication.getContext().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(BaseApplication.getContext(), permission);
    }
     ...
     */
    public static PermissionUtils permission(@PermissionConstant.Permissions final String... permissions) {
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(BaseApplication.getContext());
    }
